...
namespace UniJSON
{
    public class JsonFormatter
    {
        ...
        */
        ...
        public void Value(List<GLTFBody> a)
        {
            BeginList();
//            Debug.Log(a[0]);
            foreach (var x in a)
...
//            Debug.Log(a[0]);
        ...
        public void Value(ComponentContainer a)
        {
            BeginList();
            ...
            if(a.Rigidbodies != null){
                foreach (var rigidBody in a.Rigidbodies)
                {
                    ...
                    Key("constraints"); Value(rigidBody.constraints);
        ...
        public void Value(GLTFCollider colli)
        {
                ...
                if (colli.collider == "capsule")
                {
                    Key("direction"); Value(colli.direction);
                    Key("height"); Value(colli.height);
                    Key("radius"); Value(colli.radius);
