...
namespace UniGLTF
{
    ...
    public static class AnimationExporter
    {
       ...
       public static  List<AnimationClip> aniCLips = new List<AnimationClip>();
...
//                     if (!aniCLips.Contains(state.state.motion))
//                     {
// //                        Debug.Log(state.state.name);
//                         aniCLips.Add(state.state.motion as AnimationClip);
//                         clips.Add(state.state.motion as AnimationClip);
//                     }
//
//                     else
