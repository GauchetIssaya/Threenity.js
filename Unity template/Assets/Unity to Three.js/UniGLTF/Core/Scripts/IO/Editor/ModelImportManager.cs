...
public class ModelImportManager : EditorWindow
{
	...
	private ModelImporterAnimationType mAnimationType;
	/// METHODS ===============================================================
	...
	private void OnPreprocessModel()
	{
		...
		if( modelImporter != null )
		{
			...
			if( useImportSettings )
			{
				...
				modelImporter.optimizeMeshPolygons = EditorPrefs.GetBool( prefix + ".OptimizeMesh", false );
				modelImporter.optimizeMeshVertices  = EditorPrefs.GetBool( prefix + ".OptimizeMesh", false );
